                        ...
                        if (cartItem[e.id] > 0) {
                            return (
                                <tr key={e.id} className='border-b border-slate-900/20 p-6 medium-14 text-center'>
                                    <td className='flexCenter'><img src={e.image} alt="productImage" height={43} width={43} className='rounded-lg ring-1 ring-stone-900/5 my-1 '/></td>
                                    <td><div className='line-clamp-3 text-gray-30'>{e.name}</div></td>
                                    <td>${e.new_price}</td>
                ...
                <div className='flex flex-col gap-10'>
                    ...
                    <div>
                        ...
                        <div className='flexBetween py-4'>
                            ...
                            <h4 className='font-bold text-base'>${getTotalCartAmount()}</h4>
                        </div>
                    </div>
