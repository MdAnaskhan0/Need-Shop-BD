                ...
                <div className='flex-col flex xl:flex-[1.7]'>
                    ...
                    <div className='mb-4'>
                        ...
                        <div className='flex flex-col gap-y-3 mb-4 max-w-[555px]'>
                            <button onClick={() => {addToCart(product.id)}} className='btn_light_rounded !rounded-none uppercase regular-14 tracking-widest hover:btn_dark_rounded'>Add to cart</button>
