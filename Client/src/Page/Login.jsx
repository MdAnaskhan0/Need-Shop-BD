        ...
        <section className='max_padd_container flexCenter flex-col pt-32'>
            <div className='max-w-[555px] h-[670px] bg-white m-auto px-14 py-10 rounded-md'>
                ...
                <div className='flex flex-col gap-4 mt-7'>
                    ...
                    <input type="text" placeholder='Phone No' className='h-14 w-full pl-5 bg-slate-900/5 outline-none rounded-xl'/>
                    <input type="address" placeholder='Address' className='h-14 w-full pl-5 bg-slate-900/5 outline-none rounded-xl'/>
                </div>
