...
const Category = ({ category, banner }) => {
    ...
    return (
        <section className='max_padd_container py-12 xl:py-28'>
            <div>
                <div>
                    <img src={banner} alt="categoryBanner" className='block my-7 mx-auto' />
                </div>
                <div className='flexBetween my-8 mx-2'>
                    <h5><span className='font-bold'>Showing 1-12 </span>out of 36 products</h5>
                    <div className='flexBetween max-sm:p-4 gap-x-4 px-8 py-3 rounded-5xl ring-1 ring-slate-900/15'> Short by <MdOutlineKeyboardArrowDown /></div>
                </div>
